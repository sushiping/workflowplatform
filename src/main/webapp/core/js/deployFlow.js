var processGridColumns = [
	{id:'operation', title:'操作', type:'string', columnClass:'text-center', resolution:function(value, record, column, grid, dataNo, columnNo){
	        var content = '';
	        content += '<button title="流程发布" class="btn btn-xs btn-primary" onclick="preDeployWorkFlow('+record.id+');"><i class="glyphicon glyphicon-ok"></i> 发布</button>';
	        return content;
	 }},
...
var processGridOption = {
    ...
    gridContainer: 'gridContainerDeploy',
    toolbarContainer: 'gridToolBarContainerDeploy',
    tools: '',
    pageSize: 15,
    pageSizeLimit: '15',
