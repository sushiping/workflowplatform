    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="${ctx}/process/preStartFlow.action">流程启动<span
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive" style="margin-top: 10px;">
                <div id="gridContainerStart" class="dlshouwen-grid-container"></div>
                <div id="gridToolBarContainerStart" class="dlshouwen-grid-toolbar-container"></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="${ctx}/core/js/startFlow.js"></script>
</body>
</html>